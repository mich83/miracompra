...
ActiveRecord::Schema.define(version: 20150930194027) do
  ...
  create_table "predefined_codes", force: :cascade do |t|
    t.string   "code"
    t.boolean  "assigned"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "spree_credit_card_auths", force: :cascade do |t|
    t.integer  "order_id"
    t.integer  "amount"
    t.string   "auth_code"
    t.datetime "created_at", null: false
  ...
  create_table "spree_credit_card_payments", force: :cascade do |t|
    t.string   "number"
    t.integer  "value"
  ...
  add_index "spree_credit_card_payments", ["spree_order_id"], name: "index_spree_credit_card_payments_on_spree_order_id", using: :btree
  ...
  create_table "spree_custom_pages", force: :cascade do |t|
    t.text     "name"
    t.text     "content"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_index "spree_discounts", ["spree_taxon_id"], name: "index_spree_discounts_on_spree_taxon_id", using: :btree
  ...
  create_table "spree_products", force: :cascade do |t|
    ...
    t.string   "meta_title"
    t.string   "plan_info"
    t.boolean  "high_demand",          default: false, null: false
  ...
  add_index "spree_user_accounts", ["spree_user_id"], name: "index_spree_user_accounts_on_spree_user_id", using: :btree

  create_table "spree_user_stats", force: :cascade do |t|
    t.integer  "spree_user_id"
    t.decimal  "comisiones",       default: 0.0
    t.decimal  "bono",             default: 0.0
    t.decimal  "comercializacion", default: 0.0
    t.decimal  "c_limite",         default: 0.0
    t.decimal  "esp_recompra",     default: 0.0
    t.decimal  "esp_factura",      default: 0.0
    t.decimal  "acreditado",       default: 0.0
    t.datetime "created_at",                     null: false
    t.datetime "updated_at",                     null: false
  end
